...
<body>
<h1 style="text-align: center; margin-top: 50px">Liste des messageries</h1>
...
<div class="center">
    <table class="table table-striped">
        ...
        <tbody>
        <c:forEach var="messagerie" items="${monMessageries}">
            <tr>
                ...
                <td><a href="/ProjetRobillardMonizHou_war_exploded/addmessagerie?id=${messagerie.expediteurIDMembre}"><button style="margin: auto; background-color: #F3d4b0 " class="btn btn">Répondre</button></a></td>
            </tr>
        </c:forEach>
