...
<body>
<h1 style="text-align: center; margin-top: 50px">Liste des ppppAnnonces</h1>
<br/>
    ...
    <c:forEach var="annonce" items="${annonces}">
      <tr>
        ...
        <td>${annonce.utilisateurIDMembre}</td>
          ...
          <%--<td><a href="/?id=${annonce.idAnnonce}"><button style="margin: auto; background-color: #F3d4b0 " class="btn btn">Détail</button></a></td>--%>
