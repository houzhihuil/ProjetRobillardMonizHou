...
<%--<a href="../uploadFile"><button id="ajouterPhoto" style="margin: auto; background-color: #F3d4b0 " class="btn btn">Ajouter une photo</button></a>--%>
...
<form action="annonce" method="post" class="center">
    ...
    <div>
        <a href="../uploadFile"><img id="idPhoto" src="<c:url value='/images/camera.png'/>" alt="Uploaded Image"
                                     width="300"/></a>
